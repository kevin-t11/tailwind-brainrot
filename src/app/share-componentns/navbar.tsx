...
export const Navbar = () => {
  ...
  return (
    <nav className="mx-auto flex max-w-5xl items-center justify-between rounded-full bg-neutral-300/50 px-4 py-2 backdrop-blur-xl">
      <div className="flex items-center gap-2">
        <LogoSVG />
        <span className="text-2xl font-bold text-blue-500">Company</span>
      </div>
      <div className="flex items-center gap-4 text-neutral-900 hover:text-neutral-600">
        {navItems.map((item) => (
